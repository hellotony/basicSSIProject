                    ...
                    <div class="content">
                        <table class="contact">
                            ...
                            <tr>
                                ...
                                <td><a href="mailto:info@yourcompany.com">13122601932@163.com</a></td>
                            </tr>
                            <tr>
                                <th class="skype">QQ:</th>
                                <td>1597729349</td>
                            </tr>
                            </tbody>
                        </table>
        ...
        <div id="footer-inner">
            <div class="row">
                <div class="span6 copyright">
                    <p>© Copyright 2025 by More Templates Your Company Name - All rights reserved.</p>
                </div><!-- /.copyright -->
