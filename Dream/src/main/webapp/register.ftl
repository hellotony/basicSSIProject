...
<div class="span4">
    <div class="tab-content">
        <div class="tab-pane active" id="register">
            <form method="post" action="toRegister.do">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="inputRegisterFirstName" name="name">
                    </div>
                    <!-- /.controls -->
                </div>
                <!-- /.control-group -->
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="inputRegisterEmail" name="password1">
                    </div>
                    <!-- /.controls -->
                </div>
                <!-- /.control-group -->
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="inputRegisterPassword" name="email">
                    </div>
                    <!-- /.controls -->
                </div>
                <!-- /.control-group -->
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="inputRegisterRetype" name="remark">
                    </div>
                    <!-- /.controls -->
                </div>
                <!-- /.control-group -->
